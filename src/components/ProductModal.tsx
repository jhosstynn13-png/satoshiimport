      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="flex gap-6 pt-6">
            ...
            <button 
              type="submit"
              className="flex-1 py-5 bg-white text-black font-black rounded-[28px] transition-all shadow-[0_15px_40px_rgba(255,255,255,0.15)] active:scale-95 flex items-center justify-center gap-4 uppercase tracking-widest text-[10px] italic italic"
            >
              <Save size={20} />
              Guardar Cambios
            </button>
